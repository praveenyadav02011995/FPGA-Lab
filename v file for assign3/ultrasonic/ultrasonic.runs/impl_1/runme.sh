...
HD_PWD='C:/Users/Praveen/Downloads/ultrasonic/ultrasonic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log refresher250ms.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source refresher250ms.tcl -notrace
