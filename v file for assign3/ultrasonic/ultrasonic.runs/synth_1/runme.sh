...
HD_PWD='C:/Users/Praveen/Downloads/ultrasonic/ultrasonic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log refresher250ms.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source refresher250ms.tcl
