...
HD_PWD='C:/Users/Praveen/Downloads/project_ultra/project_ultra.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ULTRASonicSensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ULTRASonicSensor.tcl
