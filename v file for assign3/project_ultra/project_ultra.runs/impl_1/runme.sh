...
HD_PWD='C:/Users/Praveen/Downloads/project_ultra/project_ultra.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ULTRASonicSensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ULTRASonicSensor.tcl -notrace
